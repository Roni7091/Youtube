		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "youtube",
									"targetURL": "#comexamyoutubeproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comexamyoutubeproject-display": {
								"semanticObject": "comexamyoutubeproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.exam.youtubeproject",
									"url": sap.ui.require.toUrl("com/exam/youtubeproject")
								}
							}
						}
					}
